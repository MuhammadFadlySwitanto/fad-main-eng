...
export default function PowerManagement() {
  ...
  const fetchDataDayly = async () => {
    let response = await axios.get(
      "http://10.126.15.88:8002/part/getpowerdata",
      {
        params: {
          area: powerArea,
          start: startDate,
  ...
  const fetchDataMonthly = async () => {
    let response = await axios.get(
      "http://10.126.15.88:8002/part/getpowermonthly",
      {
        params: {
          area: areaMonth,
          start: startMonth,
  ...
  const fetchSec = async () => {
    let response = await axios.get(
      "http://10.126.15.88:8002/part/getPowerSec",
      {
        params: {
          area: secArea,
          start: secStart,
    ...
    let response2 = await axios.get(
      "http://10.126.15.88:8002/part/getavgpower",
      {
        params: {
          area: secArea,
          start: secStart,
    ...
    // let response1 = await axios.get("http://10.126.15.88:8002/part/getRangeSet");
