...
const HistoryTabel = () => {  
  ...
  return (
    <div className="w-full max-w-6xl mx-auto p-6 bg-card rounded-lg shadow mt-4">
        ...
        <div className="flex flex-col space-y-4 xl:w-1/3">
          ...
          <div className="space-y-2">
            ...
            <select
              ...
              className="w-full border-border bg-cobabg hover:border-border2 rounded-md py-2 px-3 focus:outline-none focus:ring-2 focus:ring-blue-500 cursor-pointer"
            >
          ...
          <div className="space-y-2">
            ...
            <select
              ...
              className="w-full md:w-32 border-border bg-cobabg hover:border-border2 rounded-md py-2 px-3 focus:outline-none focus:ring-2 focus:ring-blue-500 cursor-pointer"
            >
