  ...
  const submitHandler = async () => {
    ...
    try {
      let response = await axios.get(
        "http://10.126.15.88:8002/part/vibrate",
        {
          params: {
     ...
     let chartResponse = await axios.get("http://10.126.15.88:8002/part/vibrateChart", {
      params: {
          machine: machinePicker,
          start: datePickerStart,
          finish: datePickerFinish,
    ...
    let chartResponse2 = await axios.get("http://10.126.15.88:8002/part/vibrateChart", {
      params: {
        machine: machinePicker,
        start: datePickerStart,
        finish: datePickerFinish,
