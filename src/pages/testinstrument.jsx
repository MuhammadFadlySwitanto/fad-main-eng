...
function HardnessPage() {
  ...
  //   let response = await Axios.get("http://10.126.15.88:8002/part/getHardnessData");
  ...
  const fetchChartData = async () => {
    try {
      const hardnessResponse = await Axios.get(
        `http://10.126.15.88:8002/part/getHardnessGraph?start=${startDate}&finish=${finishDate}`
      );
      setHardnessData(
      ...
      const thicknessResponse = await Axios.get(
        `http://10.126.15.88:8002/part/getThicknessGraph?start=${startDate}&finish=${finishDate}`
      );
      setThicknessData(
      ...
      const diameterResponse = await Axios.get(
        `http://10.126.15.88:8002/part/getDiameterGraph?start=${startDate}&finish=${finishDate}`
      );
      setDiameterData(
  ...
  const fetchTableData = async () => {
    try {
      const response = await Axios.get("http://10.126.15.88:8002/part/getHardnessData");
  ...
  //       "http://10.126.15.88:8002/part/getHardnessData"
  //     );
  ...
  // useEffect(() => {
  //   const fetchData = async () => {
  //     let response = await Axios.get("http://10.126.15.88:8002/part/instrument");

  //     // Set data points for each chart
  //     let thickness = await Axios.post("http://10.126.15.88:8002/part/thickness", response.data);
  //     setThicknessData(thickness.data.map((item, i) => ({ x: i, y: Number(item.y) })));

  //     let diameter = await Axios.post("http://10.126.15.88:8002/part/diameter", response.data);
  //     setDiameterData(diameter.data.map((item, i) => ({ x: i, y: Number(item.y) })));

  //     let hardness = await Axios.post("http://10.126.15.88:8002/part/hardness", response.data);
